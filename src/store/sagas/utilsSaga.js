...
export function* paginationWorker(pagination) {
    try {
...
function* notifyWorker({ toastType, text, callback }) {
...
function* loginRequestWorker({ login, pwd, callback }) {
    try {
